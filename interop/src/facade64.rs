...
#[no_mangle]
pub extern "C" fn new_with_performance_options64(
    is_complex: i32,
    domain: i32,
    init_value: f64,
    length: usize,
...
#[no_mangle]
pub extern "C" fn new_with_detailed_performance_options64(
    is_complex: i32,
    domain: i32,
    init_value: f64,
    length: usize,
    ...
    vector.vec.set_delta(delta);
    let multicore_settings = MultiCoreSettings::with_thresholds(
        core_limit,
...
#[no_mangle]
pub extern "C" fn real_dot_product64(
    vector: &VecBuf,
    operand: &VecBuf,
...
#[no_mangle]
pub extern "C" fn complex_dot_product64(
    vector: &VecBuf,
    operand: &VecBuf,
...
pub extern "C" fn real_statistics64(vector: &VecBuf) -> Statistics<f64> {
    let vec = &vector.vec as &dyn StatisticsOps<f64, Result = Statistics<f64>>;
    vec.statistics()
}

#[no_mangle]
pub extern "C" fn complex_statistics64(vector: &VecBuf) -> Statistics<Complex64> {
    let vec = &vector.vec as &dyn StatisticsOps<Complex64, Result = Statistics<Complex64>>;
    vec.statistics()
}
...
#[no_mangle]
pub extern "C" fn real_dot_product_prec64(
    vector: &VecBuf,
    operand: &VecBuf,
) -> ScalarInteropResult<f64> {
    vector.convert_scalar(
...
#[no_mangle]
pub extern "C" fn complex_dot_product_prec64(
    vector: &VecBuf,
    operand: &VecBuf,
) -> ScalarInteropResult<Complex64> {
    vector.convert_scalar(
...
#[no_mangle]
pub extern "C" fn zero_interleave64(
    vector: Box<VecBuf>,
    factor: i32,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn complex_offset64(
    vector: Box<VecBuf>,
    real: f64,
    imag: f64,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn complex_scale64(
    vector: Box<VecBuf>,
    real: f64,
    imag: f64,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn complex_divide64(
    vector: Box<VecBuf>,
    real: f64,
    imag: f64,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn map_inplace_real64(
    vector: Box<VecBuf>,
...
#[no_mangle]
pub extern "C" fn map_inplace_complex64(
    vector: Box<VecBuf>,
...
/// it provides. Use with great care!
#[no_mangle]
pub extern "C" fn map_aggregate_complex64(
    vector: &VecBuf,
...
#[no_mangle]
pub extern "C" fn multiply_complex_exponential64(
    vector: Box<VecBuf>,
    a: f64,
    b: f64,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn add_smaller_vector64(
    vector: Box<VecBuf>,
    operand: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn sub_smaller_vector64(
    vector: Box<VecBuf>,
    operand: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn div_smaller_vector64(
    vector: Box<VecBuf>,
    operand: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn mul_smaller_vector64(
    vector: Box<VecBuf>,
    operand: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn get_real_imag64(
    vector: Box<VecBuf>,
    real: &mut VecBuf,
    imag: &mut VecBuf,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn get_mag_phase64(
    vector: Box<VecBuf>,
    mag: &mut VecBuf,
    phase: &mut VecBuf,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn set_real_imag64(
    vector: Box<VecBuf>,
    real: &VecBuf,
    imag: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn set_mag_phase64(
    vector: Box<VecBuf>,
    mag: &VecBuf,
    phase: &VecBuf,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn overwrite_data64(
...
#[no_mangle]
pub extern "C" fn real_statistics_split64(
    vector: &VecBuf,
    data: *mut Statistics<f64>,
    len: usize,
) -> i32 {
    let data = unsafe { slice::from_raw_parts_mut(data, len) };
    let vec = &vector.vec as &dyn StatisticsSplitOps<f64, Result = StatsVec<Statistics<f64>>>;
...
#[no_mangle]
pub extern "C" fn complex_statistics_split64(
    vector: &VecBuf,
    ...
    let data = unsafe { slice::from_raw_parts_mut(data, len) };
    let vec =
        &vector.vec as &dyn StatisticsSplitOps<Complex64, Result = StatsVec<Statistics<Complex64>>>;
    let stats = vec.statistics_split(data.len());
    match stats {
        Ok(s) => {
            for i in 0..s.len() {
...
#[no_mangle]
pub extern "C" fn real_statistics_split_prec64(
    vector: &VecBuf,
    data: *mut Statistics<f64>,
    len: usize,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn complex_statistics_split_prec64(
    vector: &VecBuf,
    data: *mut Statistics<Complex64>,
    len: usize,
) -> i32 {
...
/// See [`apply_window64`](fn.apply_window64.html) for a description of the `window` parameter.
#[no_mangle]
pub extern "C" fn windowed_sifft64(
    vector: Box<VecBuf>,
    window: i32,
) -> VectorInteropResult<VecBuf> {
    let window = translate_to_window_function(window);
...
#[no_mangle]
pub extern "C" fn unapply_custom_window64(
    vector: Box<VecBuf>,
    window: extern "C" fn(*const c_void, usize, usize) -> f64,
    window_data: *const c_void,
    is_symmetric: bool,
...
/// `window` and `window_data` parameter.
#[no_mangle]
pub extern "C" fn windowed_custom_fft64(
    vector: Box<VecBuf>,
    window: extern "C" fn(*const c_void, usize, usize) -> f64,
    window_data: *const c_void,
    is_symmetric: bool,
...
/// `window` and `window_data` parameter.
#[no_mangle]
pub extern "C" fn windowed_custom_sfft64(
    vector: Box<VecBuf>,
    window: extern "C" fn(*const c_void, usize, usize) -> f64,
    window_data: *const c_void,
    is_symmetric: bool,
...
/// `window` and `window_data` parameter.
#[no_mangle]
pub extern "C" fn windowed_custom_ifft64(
    vector: Box<VecBuf>,
    window: extern "C" fn(*const c_void, usize, usize) -> f64,
    window_data: *const c_void,
    is_symmetric: bool,
...
/// `window` and `window_data` parameter.
#[no_mangle]
pub extern "C" fn windowed_custom_sifft64(
    vector: Box<VecBuf>,
    window: extern "C" fn(*const c_void, usize, usize) -> f64,
    window_data: *const c_void,
    is_symmetric: bool,
...
#[no_mangle]
pub extern "C" fn convolve_signal64(
    vector: Box<VecBuf>,
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn convolve_real64(
    vector: Box<VecBuf>,
    ...
    unsafe {
        let function: &dyn RealImpulseResponse<f64> = &ForeignRealConvolutionFunction {
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn convolve_complex64(
    vector: Box<VecBuf>,
    impulse_response: extern "C" fn(*const c_void, f64) -> Complex64,
    impulse_response_data: *const c_void,
    is_symmetric: bool,
    ratio: f64,
    len: usize,
    ...
    unsafe {
        let function: &dyn ComplexImpulseResponse<f64> = &ForeignComplexConvolutionFunction {
            conv_function: impulse_response,
            conv_data: mem::transmute(impulse_response_data),
            is_symmetric: is_symmetric,
        };
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn multiply_frequency_response_real64(
    vector: Box<VecBuf>,
    ...
    unsafe {
        let function: &dyn RealFrequencyResponse<f64> = &ForeignRealConvolutionFunction {
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn multiply_frequency_response_complex64(
    vector: Box<VecBuf>,
    frequency_response: extern "C" fn(*const c_void, f64) -> Complex64,
    frequency_response_data: *const c_void,
    is_symmetric: bool,
    ratio: f64,
) -> VectorInteropResult<VecBuf> {
    unsafe {
        let function: &dyn ComplexFrequencyResponse<f64> = &ForeignComplexConvolutionFunction {
            conv_function: frequency_response,
            conv_data: mem::transmute(frequency_response_data),
            is_symmetric: is_symmetric,
        };
...
#[no_mangle]
pub extern "C" fn multiply_frequency_response64(
    vector: Box<VecBuf>,
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn interpolatef_custom64(
    vector: Box<VecBuf>,
    impulse_response: extern "C" fn(*const c_void, f64) -> f64,
    impulse_response_data: *const c_void,
    is_symmetric: bool,
...
/// `rolloff` is only used if this is a valid parameter for the selected `impulse_response`
#[no_mangle]
pub extern "C" fn interpolatef64(
    vector: Box<VecBuf>,
    impulse_response: i32,
    rolloff: f64,
    interpolation_factor: f64,
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn interpolate_custom64(
    vector: Box<VecBuf>,
    frequency_response: extern "C" fn(*const c_void, f64) -> f64,
    frequency_response_data: *const c_void,
    is_symmetric: bool,
...
/// function at every call and can be used to store parameters.
#[no_mangle]
pub extern "C" fn interpolatei_custom64(
    vector: Box<VecBuf>,
    frequency_response: extern "C" fn(*const c_void, f64) -> f64,
    frequency_response_data: *const c_void,
    is_symmetric: bool,
...
#[no_mangle]
pub extern "C" fn interpolate_lin64(
    vector: Box<VecBuf>,
    interpolation_factor: f64,
    delay: f64,
) -> VectorInteropResult<VecBuf> {
...
#[no_mangle]
pub extern "C" fn interpolate_hermite64(
    vector: Box<VecBuf>,
    interpolation_factor: f64,
    delay: f64,
) -> VectorInteropResult<VecBuf> {
