...
#[no_mangle]
pub extern "C" fn new_with_detailed_performance_options32(
    is_complex: i32,
    domain: i32,
    init_value: f32,
    length: usize,
...
#[no_mangle]
pub extern "C" fn data32(vector: &VecBuf) -> *const f32 {
    vector.vec.data(..).as_ptr()
}

#[no_mangle]
pub extern "C" fn complex_data32(vector: &VecBuf) -> *const Complex32 {
...
#[no_mangle]
pub extern "C" fn real_sum_prec32(vector: &VecBuf) -> f64 {
    vector.vec.sum_prec()
}

#[no_mangle]
pub extern "C" fn real_sum_sq_prec32(vector: &VecBuf) -> f64 {
    vector.vec.sum_sq_prec()
}

#[no_mangle]
pub extern "C" fn complex_sum_prec32(vector: &VecBuf) -> Complex64 {
    vector.vec.sum_prec()
}

#[no_mangle]
pub extern "C" fn complex_sum_sq_prec32(vector: &VecBuf) -> Complex64 {
    vector.vec.sum_sq_prec()
}
