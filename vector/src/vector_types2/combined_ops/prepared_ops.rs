...
pub trait PreparedOperation2Exec<B, S1, S2, D1, D2> {
    /// Executes the prepared operations to convert `S1` and `S2` to `D1` and `D2`.
    fn exec(&self, buffer: &mut B, source1: S1, source2: S2) -> result::Result<(D1, D2), (ErrorReason, D1, D2)>;
}

/// Prepares an operation with one input and one output.
pub fn prepare32_2<N1, D1, N2, D2>(number_space1: N1, domain1: D1, number_space2: N2, domain2: D2)
    -> PreparedOperation2<f32, N1, D1, N2, D2, N1, D1, N2, D2>
    where
        N1: NumberSpace, D1: Domain,
        N2: NumberSpace, D2: Domain {
    PreparedOperation2
         {
...
/// Prepares an operation with one input and one output.
pub fn prepare64_2<N1, D1, N2, D2>(number_space1: N1, domain1: D1, number_space2: N2, domain2: D2)
